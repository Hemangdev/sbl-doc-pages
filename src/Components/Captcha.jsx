...
let fontColor_value = '';
let charMap_value = '';
let LoadCanvasTemplate_HTML = "<div  class='d-flex'><canvas id=\"canv\"></canvas><div><a id=\"reload_href\"  style=\"cursor: pointer; color: blue\">Reload Captcha</a></div></div>";
...
export class LoadCanvasTemplate extends Component {
    ...
    render() {
        ...
        let reload_color = "";
        let id = "canv";
        LoadCanvasTemplate_HTML = "<div class='d-flex justify-content-center align-items-center'><canvas id=\"" + id + "\" style=\"background-color: blue;\"></canvas><a id=\"reload_href\"  style=\"cursor: pointer; color: blue\">Reload Captcha</a></div></div>";
        ...
        if (reload_text === "") {
            reload_text = "<span role='botton' class='btn btn-outline-success btn-sm'><i class='fa fa-refresh mx-2'></i></span>";
        }
        ...
        LoadCanvasTemplate_HTML = "<div class='d-flex justify-content-center align-items-center' style='height: 38px;'><canvas id=\"" + id + "\"></canvas><a id=\"reload_href\"  style=\"cursor: pointer; color: " + reload_color + "\">" + reload_text + "</a></div>";
